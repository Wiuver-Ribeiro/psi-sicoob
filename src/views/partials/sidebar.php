...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo $base . '/assets/css/components/'?>">
...
<main >
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark row" style="width: 280px; height:100vh;">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow" aria-labelledby="dropdownUser1">
        ...
        <li><a class="dropdown-item" href="<?php echo $base .'/appointments'; ?>">Agendamentos</a></li>
        <li><a class="dropdown-item" href="<?php echo $base .'/config'; ?>">Configurações</a></li>
