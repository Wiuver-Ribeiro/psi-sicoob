<aside class="sidebar menu-mobile">
  ...
  <div class="box-sidebar">
    ...
    <ul>
      ...
      <li class="tab"><a title="Pacientes" class="link-menu" href="<?php echo $base .'/patients'?> " onclick="activeTab('patients')" ><i class="fas fa-user-alt" style="color:#8DC9E8; margin-right:1rem;"></i>Pacientes</a></li>
      <li class="tab"><a title="Administradores" class="link-menu" href="<?php echo $base .'/admins'; ?>" onclick="activeTab('admins')" ><i class="fas fa-lock" style="color:#F4C22B; margin-right:1rem;"></i>Administradores</a></li>
